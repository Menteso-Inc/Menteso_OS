...
result=({"mode":"single_live","enabled":True} if a.enable_single_live else
        ...
        (agent.send_multi_payment_test(a.customer_id,(a.test_to or [""])[0]) if a.send_multi_payment_test else
